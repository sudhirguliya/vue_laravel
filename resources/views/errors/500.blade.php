...
<head>
    ...
    <title>500 Internal Error | NewImage</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <!-- global level js -->
    <link rel="stylesheet" type="text/css" href="{{ asset('admin/css/frontend/bootstrap.min.css') }}">
    <!-- end of global js-->
    <!-- page level styles-->
    <link href="{{ asset('admin/css/frontend/500.css') }}" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <!--livicons-->
    <script src="{{ asset('admin/js/frontend/raphael.js') }}"></script>
    <script src="{{ asset('admin/js/livicons-1.4.min.js') }}"></script>
    <!-- end of global js -->
